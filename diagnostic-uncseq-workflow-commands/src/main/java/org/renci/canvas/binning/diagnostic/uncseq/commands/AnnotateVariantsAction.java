...
import org.renci.canvas.binning.diagnostic.uncseq.commons.AnnotateVariantsCallable;
...
@Command(scope = "diagnostic-uncseq", name = "annotate-variants", description = "Annotate Variants")
@Service
